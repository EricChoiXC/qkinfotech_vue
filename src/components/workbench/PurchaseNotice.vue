...
<template>
  <n-card :footer-style="{ justifyContent: 'end' }">
        ...
        <div style="font-weight: bold">
          <n-icon style="padding-top: 4px" size="20" color="blue">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
              <path opacity=".3" d="M11 11h5v5h-5zm-7 0h5v5H4zm0-7h12v5H4z" fill="currentColor"></path>
              <path d="M20 6v14H6v2h14c1.1 0 2-.9 2-2V6h-2z" fill="currentColor"></path>
              <path
    ...
    <n-list hoverable clickable>
      <n-list-item v-for="(item, index) in limitedItems" :key="index" @click="handleLink(item.href)">
        <template #suffix>
          <n-space>
