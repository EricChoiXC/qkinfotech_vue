...
export default class request {
  ...
  #findTab = (crrentInstance) => {
    ...
    if (crrentInstance !== null && crrentInstance.parent) {
  ...
  constructor(crrentInstance) {
    ...
    this.get = (url) => {
      return service.get(url, { crrentTab: this.crrentTab })
    }
    this.get = (url, param) => {
      return service.get(url, { params: param, crrentTab: this.crrentTab })
    }
